...
setup(
    name='NAME HERE',  # Replace with your package's name
    version='0.1.0',  # Initial version of your package
    author='AUTHOR NAME',  # Replace with your name
    author_email='EMAIL',  # Replace with your email address
    ...
    url='GITHUB URL',  # Replace with the URL of your package's repository
    ...
    classifiers=[
        ...
        'Programming Language :: Python :: 3',  # Specify which python version you support
